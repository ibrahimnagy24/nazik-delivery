...
class OTPValidator {
  static String? otpValidator(String? otp) {
    if (otp == null || otp.length < 6) {
      return allTranslations.text("verification_code_validation");
    }
    return null;
  }
}
...
class PasswordConfirmationValidator {
  static String? passwordValidator(String? password, String? confirmPassword) {
    if (confirmPassword == null || confirmPassword.isEmpty) {
      return allTranslations.text("enter_confirm_password_validation");
    } else if (confirmPassword.length < 8) {
      return allTranslations.text("confirm_password_length_validation");
    } else if (password != null) {
      if (password != confirmPassword) {
        return allTranslations.text("confirm_password_match_validation");
      }
    }
    return null;
  }
...
class NewPasswordValidator {
  static String? passwordValidator(String? password, String? newPassword) {
    if (newPassword == null || newPassword.isEmpty) {
      return allTranslations.text("enter_new_password_validation");
    } else if (newPassword.length < 8) {
      return allTranslations.text("new_password_length_validation");
    } else if (password != null) {
      if (password == newPassword) {
        return allTranslations.text("new_password_match_validation");
      }
    }
    return null;
  }
...
class NewPasswordConfirmationValidator {
  static String? passwordValidator(
    ...
    if (confirmPassword == null || confirmPassword.isEmpty) {
      ...
      if (newPassword != confirmPassword) {
        return allTranslations.text("confirm_new_password_match_validation");
      }
    }
    return null;
  }

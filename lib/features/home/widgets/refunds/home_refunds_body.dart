...
class HomeRefundsBody extends StatefulWidget {
  const HomeRefundsBody({super.key});

  @override
  State<HomeRefundsBody> createState() => _HomeRefundsBodyState();
}

class _HomeRefundsBodyState extends State<HomeRefundsBody> {
  late ScrollController controller;

  @override
  void initState() {
    controller = ScrollController();
    HomeRefundsRequestsBloc.instance.customScroll(controller);
    if (HomeRefundsRequestsBloc.instance.state is! Done) {
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: BlocBuilder<HomeRefundsRequestsBloc, AppState>(

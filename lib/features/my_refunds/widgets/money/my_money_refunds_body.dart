...
class MyMoneyRefundsBody extends StatefulWidget {
  const MyMoneyRefundsBody({super.key});

  @override
  State<MyMoneyRefundsBody> createState() => _MyMoneyRefundsBodyState();
}

class _MyMoneyRefundsBodyState extends State<MyMoneyRefundsBody> {
  late ScrollController controller;

  @override
  void initState() {
    controller = ScrollController();
    MyMoneyRefundsBloc.instance.customScroll(controller);
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: BlocBuilder<MyMoneyRefundsBloc, AppState>(
